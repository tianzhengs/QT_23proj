...
# Template: app
# Command: D:\Qt\6.5.1\mingw_64\bin\qmake.exe -o Makefile MyProject.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: MyProject.pro D:/Qt/6.5.1/mingw_64/mkspecs/win32-g++/qmake.conf D:/Qt/6.5.1/mingw_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile MyProject.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
